import { FaTimes, FaUser, FaEnvelope, FaPhone, FaMapMarkerAlt, FaBuilding, FaBriefcase, FaGraduationCap, FaCalendar, FaFileAlt } from 'react-icons/fa';
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-4 sm:p-6 mb-4">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="text-xl sm:text-2xl font-semibold text-gray-900 mb-1">{faculty.name}</h3>
                  <p className="text-sm text-gray-600 mb-2">{faculty.faculty_id || faculty.id}</p>
                  <div className="flex flex-wrap items-center gap-3">
                    <span className={`inline-flex px-2.5 py-1 text-xs font-medium rounded border ${getStatusColor(faculty.status)}`}>
                      {faculty.status ? faculty.status.charAt(0).toUpperCase() + faculty.status.slice(1) : 'Active'}
                    </span>
                    <div className="flex items-center gap-1 text-sm">
                      <span className="text-gray-500">Position:</span>
                      <span className="font-semibold text-orange-600">{faculty.position || 'N/A'}</span>
                    </div>
                    <div className="flex items-center gap-1 text-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-2">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-sm text-gray-900 truncate">{faculty.email || 'N/A'}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-900">{faculty.phone || 'N/A'}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-900">{faculty.address || 'N/A'}</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-start gap-2">
                    <FaBriefcase className="text-gray-400 text-sm mt-0.5 shrink-0" />
                    <div className="flex-1">
                      <p className="text-xs text-gray-500">Position</p>
                      <p className="text-sm text-gray-900">{faculty.position || 'N/A'}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-900">{faculty.specialization || 'N/A'}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-900">{formatDate(faculty.hire_date || faculty.hireDate)}</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-2">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-900">{faculty.office || 'N/A'}</p>
                    </div>
                  </div>
