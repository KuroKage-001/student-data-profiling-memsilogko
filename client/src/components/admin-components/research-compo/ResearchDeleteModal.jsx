...
const ResearchDeleteModal = ({ isOpen, onClose, onConfirm, research, loading }) => {
      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full">
        ...
        <div className="p-6">
          <p className="text-gray-700 mb-4">
            Are you sure you want to delete this research material?
          </p>
          {research && (
            <div className="bg-gray-50 rounded-lg p-4 mb-4">
              <p className="font-semibold text-gray-900">{research.title}</p>
              <p className="text-sm text-gray-600 mt-1">by {research.author}</p>
            </div>
          )}
