      ...
      <div className="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 w-full">
          <div className="flex items-center space-x-2 sm:space-x-4">
            ...
            >
              <div className="w-10 h-10 bg-gradient-to-br from-orange-500 to-orange-600 rounded-xl flex items-center justify-center shadow-md group-hover:shadow-lg transition-all duration-300 group-hover:scale-105">
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            <div className="hidden lg:flex items-center gap-4 px-6 py-2 bg-gradient-to-r from-orange-50 to-orange-100 rounded-xl border border-orange-200">
            ...
            <div className="relative" ref={dropdownRef}>
              <button
                ...
                className="flex items-center space-x-2 sm:space-x-3 text-gray-700 hover:text-gray-900 transition-all duration-200 p-2 pr-2 sm:pr-3 rounded-xl hover:bg-gray-50 border-2 border-transparent hover:border-orange-200"
              >
                ...
                <svg 
                  className={`w-4 h-4 transition-transform duration-300 text-gray-400 hidden sm:block ${isDropdownOpen ? 'rotate-180' : ''}`} 
                  fill="none" 
                  stroke="currentColor" 
                  viewBox="0 0 24 24"
                >
