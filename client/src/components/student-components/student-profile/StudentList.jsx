  ...
  return (
    <div className="bg-white border-2 border-gray-200 rounded-lg overflow-hidden">
      ...
      <div className="lg:hidden">
        {filteredStudents.map((student) => (
          <div key={student.id} className="border-b border-gray-200 last:border-b-0 p-4 hover:bg-gray-50">
            <div className="flex items-start justify-between mb-3">
              <div className="flex-1">
                <h3 className="text-base font-semibold text-black mb-1">{student.name}</h3>
              ...
              <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${getStatusColor(student.status)} ml-2`}>
                {student.status}
              </span>
            </div>
            ...
            <div className="flex items-center justify-between">
              <div className="text-sm">
                ...
                <span className="font-semibold text-black">{student.gpa}</span>
              </div>
      ...
      {filteredStudents.length === 0 && (
        <div className="text-center py-8 px-4">
          <p className="text-gray-500 text-sm sm:text-base">No students found matching your search criteria.</p>
        </div>
      )}
    </div>
  );
