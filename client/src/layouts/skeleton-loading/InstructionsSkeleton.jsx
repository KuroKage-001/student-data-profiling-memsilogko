    ...
    <div className="min-h-screen bg-linear-to-br from-gray-50 via-orange-50/30 to-gray-50 p-4 sm:p-6 lg:p-8">
      ...
      <div className="mb-8 sm:mb-10">
        <div className="flex items-center gap-3 mb-3">
          ...
          <div>
            <div className="h-9 sm:h-10 bg-gray-300 rounded w-64 sm:w-72 lg:w-80 animate-pulse"></div>
          </div>
        </div>
        <div className="ml-16 h-5 sm:h-6 bg-gray-200 rounded w-56 sm:w-72 lg:w-80 animate-pulse"></div>
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5 mb-8 sm:mb-10">
        {[
          ...
          { icon: FaClipboardList, color: 'yellow' },
          { icon: FaGraduationCap, color: 'blue' }
        ].map((stat, i) => (
      ...
      <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 mb-6">
        ...
        {/* Add Button Skeleton */}
        <div className="h-12 sm:h-13 bg-gray-200 rounded-xl w-full sm:w-52 animate-pulse"></div>
      </div>

      {/* Instructions Table Skeleton */}
                ...
                <tr key={row} className="hover:bg-gray-50">
                  <td className="px-4 sm:px-6 py-4">
                    <div className="flex items-start">
                      <div className="w-6 h-6 sm:w-8 sm:h-8 bg-gray-200 rounded mr-2 sm:mr-3 animate-pulse"></div>
                      <div className="min-w-0 flex-1 space-y-2">
                        <div className="h-4 bg-gray-300 rounded w-56 sm:w-72 animate-pulse"></div>
                        <div className="h-3 bg-gray-200 rounded w-full sm:w-96 animate-pulse"></div>
                        <div className="h-3 bg-gray-200 rounded w-32 animate-pulse"></div>
                        <div className="sm:hidden h-3 bg-gray-200 rounded w-48 animate-pulse"></div>
                      </div>
                    </div>
                  </td>
