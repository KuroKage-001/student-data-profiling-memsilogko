          ...
          <div key={index} className="border-b border-gray-200 last:border-b-0 p-4 sm:p-5">
            <div className="space-y-3">
              ...
              <div className="flex-1 min-w-0 space-y-2">
                <div className="h-5 sm:h-6 bg-gray-300 rounded w-32 sm:w-40 animate-pulse"></div>
                <div className="h-3.5 sm:h-4 bg-gray-200 rounded w-40 sm:w-48 animate-pulse"></div>
              ...
              <div className="flex flex-col xs:flex-row xs:items-center xs:justify-between gap-2.5 pt-3 border-t border-gray-200">
                ...
                <div className="flex gap-2">
                  <div className="h-9 sm:h-10 bg-gray-200 rounded-lg flex-1 xs:flex-none xs:w-16 sm:xs:w-20 animate-pulse"></div>
                  <div className="h-9 sm:h-10 bg-gray-200 rounded-lg flex-1 xs:flex-none xs:w-16 sm:xs:w-20 animate-pulse"></div>
                </div>
              </div>
            </div>
