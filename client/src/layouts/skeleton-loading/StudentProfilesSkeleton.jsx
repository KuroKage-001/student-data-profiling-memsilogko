  ...
  return (
    <div className="h-[calc(100vh-4rem)] overflow-hidden bg-linear-to-br from-gray-50 via-orange-50/30 to-gray-50 p-3 sm:p-4 md:p-6 lg:p-8 flex flex-col">
      ...
      <div className="mb-4 sm:mb-6 shrink-0">
        ...
        <div className="ml-10 sm:ml-13 h-4 sm:h-5 bg-gray-200 rounded w-56 sm:w-72 animate-pulse"></div>
      </div>
      ...
      {/* Student List Skeleton - Scrollable */}
...
export default StudentProfilesSkeleton;
